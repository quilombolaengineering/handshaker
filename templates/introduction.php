<section class="section-introduction">
	...
	<div class="container-fluid organization-introduction">
		<div class="v-center">
			...
			<!-- Introduction Text -->
			<div class="col-xs-8 col-xs-offset-2 col-md-6 introduction-title"><h2>About Us</h2></div>
			<div class="col-xs-8 col-xs-offset-2 col-md-6 introduction-line"><div class="colored-line"></div></div>
			<div class="col-xs-8 col-xs-offset-2 col-md-6 introduction-text">Handshaker is a Wordpress Theme created by Quilombola Engineering. 
