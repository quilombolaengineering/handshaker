<section class="section-introduction">
	...
	<div class="container-fluid organization-introduction">
		<div class="row">
			...
			<!-- Introduction Text -->
			<div class="col-md-6">
				<div class="col-xs-10 col-xs-offset-1 introduction-title"><h2>About Us</h2></div>
				<div class="col-xs-10 col-xs-offset-1 introduction-line"><div class="colored-line"></div></div>
				<div class="col-xs-10 col-xs-offset-1 introduction-text">Handshaker is a Wordpress Theme created by Quilombola Engineering. 
