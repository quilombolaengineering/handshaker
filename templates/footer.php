<section id="footer" class="section-footer">
	...
	<div class="v-center">
		<div class="row">
		        ...
		        <div class="col-md-3">
	                	<h2>分享Share</h2>
				<div onmousedown="sploob()" class="col-xs-6 col-md-2"><i class="fa fa-facebook" aria-hidden="true"></i></div>
				<div onmousedown="sploob()" class="col-xs-6 col-md-2"><i class="fa fa-weixin" aria-hidden="true"></i></div>
		        </div>
		        <div class="col-md-3">
		                <h2>链接Links</h2>
